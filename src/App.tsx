        ...
        <div className="modal-overlay" onClick={() => setIsHelpOpen(false)}>
          <div className="modal-content help-modal" onClick={e => e.stopPropagation()}>
            <div className="help-modal-header">
              {/* Top-left: chat/discussions icon */}
              <a href="https://github.com/fp101fs/simpad-community/discussions" target="_blank" rel="noopener noreferrer" className="help-corner-icon left" title="Community Discussions">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.17L4 17.17V4h16v12z"/>
                </svg>
              </a>
              <h3 style={{margin: 0, fontSize: '1.6rem', fontWeight: 800}}>Help & Resources</h3>
              {/* Top-right: GitHub logo */}
              <a href="https://github.com/fp101fs/simpad-community" target="_blank" rel="noopener noreferrer" className="help-corner-icon right" title="GitHub Repository">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="help-links">
              <div className="help-section-label">How to Use Simp.Ad</div>

              {/* YouTube (formerly "Promo Video") — now first */}
              <a href="https://youtube.com/shorts/hpP813bxHKA" target="_blank" rel="noopener noreferrer" className="help-link-row">
                <span className="help-link-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#FF0000"><path d="M23.5 6.19a3.02 3.02 0 0 0-2.12-2.14C19.54 3.5 12 3.5 12 3.5s-7.54 0-9.38.55A3.02 3.02 0 0 0 .5 6.19C0 8.04 0 12 0 12s0 3.96.5 5.81a3.02 3.02 0 0 0 2.12 2.14C4.46 20.5 12 20.5 12 20.5s7.54 0 9.38-.55a3.02 3.02 0 0 0 2.12-2.14C24 15.96 24 12 24 12s0-3.96-.5-5.81zM9.75 15.52V8.48L15.5 12l-5.75 3.52z"/></svg>
                </span>
                <span className="help-link-text"><strong>Watch a Quick YouTube Demo</strong><span className="help-link-sub">YouTube Short</span></span>
                <span className="help-link-arrow">↗</span>
              </a>

              {/* Supademo (formerly "Watch Demo") — now second */}
              <a href="https://app.supademo.com/demo/cmmg7l4i156aknr996x66pzrw?utm_source=link" target="_blank" rel="noopener noreferrer" className="help-link-row">
                <span className="help-link-icon" style={{fontSize: '18px', color: '#60a5fa'}}>▶</span>
                <span className="help-link-text"><strong>View Interactive Walk-Through</strong><span className="help-link-sub">Supademo walkthrough</span></span>
                <span className="help-link-arrow">↗</span>
              </a>
              ...
              <a href="https://github.com/fp101fs/simpad-community/issues/new?template=bug_report.yml" target="_blank" rel="noopener noreferrer" className="help-link-row">
                <span className="help-link-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="#f97316"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></svg>
                </span>
              ...
              <a href="https://github.com/fp101fs/simpad-community/issues/new?template=feature_request.yml" target="_blank" rel="noopener noreferrer" className="help-link-row">
                <span className="help-link-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="#a78bfa"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"/></svg>
                </span>
              ...
              <a href="https://github.com/fp101fs/simpad-community/issues/new?template=support.yml" target="_blank" rel="noopener noreferrer" className="help-link-row">
                <span className="help-link-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="#38bdf8"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15v-4H7l5-8v4h4l-5 8z"/></svg>
                </span>
      ...
      <div className="container">
        ...
        {error && (
          <p className="error">
            ...
            {rateLimitHit && (
              <>
                {' '}
                <button className="google-signin-btn inline-signin" onClick={() => googleLogin()}>
                  ...
                  Sign in with Google
                </button>{' '}for 100 FREE AI ad generations every 24 hours.
              </>
            )}
          </p>
        )}
        ...
        {result && (
          <div className="ad-preview">
            ...
            <div className="ad-canvas-wrapper">
